...
export default function Navbar({
  ...
  return (
    <motion.nav
      ...
      /* YAHAN 100% BULLETPROOF FIX HAI */
      className="fixed top-3 left-4 right-4 z-50 mx-auto max-w-4xl sm:top-4 sm:left-auto sm:right-auto sm:w-[95%]"
    >
      <div className="glass flex w-full items-center justify-between rounded-full px-3 py-2 shadow-lg shadow-black/30 sm:px-6 sm:py-2.5">
