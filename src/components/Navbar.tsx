...
export default function Navbar({
  ...
  return (
    <motion.nav
      ...
      className="fixed top-3 left-1/2 z-50 w-[calc(100%-1.5rem)] max-w-4xl -translate-x-1/2 sm:top-4"
    >
      <div className="glass flex items-center justify-between rounded-full px-3.5 py-2 shadow-lg shadow-black/30 sm:px-6 sm:py-2.5">
        {/* Logo */}
        <a href="#home" data-cursor-hover className="shrink-0 font-display text-base font-bold tracking-tight text-white sm:text-lg">
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-3">
          <div className="relative shrink-0">
            <button
              ...
              data-cursor-hover
              className="flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 p-2 text-slate-300 transition hover:border-cyan-400/50 hover:text-cyan-300 sm:px-3 sm:py-1.5 font-mono text-[11px]"
            >
